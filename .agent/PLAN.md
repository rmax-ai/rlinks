...
- **BH1: Worker hit-logging benchmark** [In Progress]
  ...
  - Commands: a script that issues N concurrent requests, measures p50/p95 latency, and captures error rates/cost estimates.  (Next: run on local machine and add final numbers to `docs/benchmarks/worker-hit-logging.md`)
